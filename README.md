...
| Area | Skills |
|------|--------|
| 📐 Mobile UI | App screens, Onboarding, Dashboard |
| 🎯 UX Research | User flows, Wireframes, Prototypes |
| ✨ Animations | Micro-interactions, Lottie, Flutter animations |
...
|---------|------|-------------|
| 🚨 **Scam Alert App** | Flutter + UI | Foydalanuvchilarni firibgarlikdan himoya qiluvchi ilova |
| 🔐 **Secure Gallery** | Flutter + UI | Shifrlangan, minimal dizaynli galereya |
| 🛵 **Delivery App** | Flutter | Real-time kuzatish va onboarding UI |
| 💰 **Expense Tracker** | Flutter + UI | Dashboard dizaynli moliya boshqaruvi |
| 📅 **Work Scheduler** | Flutter + UI | Clean calendar va drag & drop interfeys |
| 📍 **Map Tracker** | Flutter | Custom map UI bilan joylashuv kuzatish |
